...
public class UserSubscriptionService {
    ...
    public UserSubscriptionResponseDto getUserSubscription() {
        ...
        return UserSubscriptionResponseDto.builder()
                ...
                .qbankAccess(subscription.getSubscriptionPlan().getQbankAccess())
                .videoAccess(subscription.getSubscriptionPlan().getVideoAccess())
                .liveClassAccess(subscription.getSubscriptionPlan().getLiveClassAccess())
                .aiAccess(subscription.getSubscriptionPlan().getAiAccess())
                .build();
    }
}
