    ...
    public List<UserSubscriptionDto> getAllSubscriptions() {
        ...
        return subscriptionRepository.findAll().stream()
                .map(sub -> UserSubscriptionDto.builder()
                        ...
                        .paymentMethod(sub.getPaymentMethod() != null ? sub.getPaymentMethod() : "Razorpay")
                        .autoRenew(sub.getAutoRenew() != null ? sub.getAutoRenew() : true)
                        .cardBrand(sub.getCardBrand())
                        .cardLastFour(sub.getCardLastFour())
                        .cardExpiry(sub.getCardExpiry())
                        .cardHolderName(sub.getCardHolderName())
                        .build())
