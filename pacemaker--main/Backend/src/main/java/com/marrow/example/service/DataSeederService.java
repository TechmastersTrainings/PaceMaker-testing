...
public class DataSeederService {
    ...
    private void seedCourses() {
        ...
        courseRepository.save(Course.builder()
                ...
                .description("Deep-dive into clinical pathology with 22 case-based lectures. Covers general pathology, systemic pathology, histopathology slides interpretation, and high-frequency exam topics in detail.")
                .subject("Pathology")
