...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#040811] relative overflow-hidden mt-auto border-t border-white/[0.04]">
      ...
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-blue-500/[0.015] rounded-full blur-[110px] pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5 bg-white/[0.01] px-2.5 py-1.5 rounded-lg border border-white/[0.04]">
              ...
              <span className="text-[9px] font-bold tracking-widest text-stone-400 uppercase">Razorpay Secure</span>
            </div>
            <div className="flex items-center gap-1.5 bg-white/[0.01] px-2.5 py-1.5 rounded-lg border border-white/[0.04]">
              <span className="text-[9px] font-black text-emerald-400">PCI-DSS</span>
              <span className="text-[9px] font-semibold text-stone-500">COMPLIANT</span>
            </div>
          </div>
