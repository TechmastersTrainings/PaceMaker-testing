          ...
          <div className="bg-white border-2 border-red-500 rounded-[2.5rem] p-8 md:p-12 max-w-lg w-full text-center shadow-xl space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 px-5 py-3 bg-primary-600 hover:bg-blue-700 text-white rounded-xl font-bold text-sm transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
              >
