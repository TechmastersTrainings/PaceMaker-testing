...
export default function StudyMaterialLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { icon: Repeat, label: 'Revision Videos', href: '/dashboard/revision-videos' },
    { icon: MessageSquare, label: 'MCQ Discussions', href: '/dashboard/mcq-discussions' },
    { icon: GitBranch, label: 'Flowcharts', href: '/dashboard/flowcharts' },
    { icon: Image, label: 'Clinical Images', href: '/dashboard/clinical-images' },
    { icon: Wrench, label: 'Revision Tools', href: '/dashboard/revision-tools' },
