        ...
        >
          <div className="p-12 md:p-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              {[
                { label: 'Total Duration', value: `${exam.duration} Minutes`, icon: Clock, color: 'bg-primary-100 text-primary-600' },
               ...
               <div className="p-12 md:p-20 flex flex-col items-center text-center">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
                     {[
                       ...
                       { label: 'Percentage', value: `${scorePct.toFixed(1)}%`, icon: BarChart3, color: 'text-primary-600' },
