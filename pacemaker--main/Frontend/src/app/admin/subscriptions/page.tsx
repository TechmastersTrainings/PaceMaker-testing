...
function AdminSubscriptionsPage() {
  ...
  const planColors: Record<string, string> = {
    Basic: 'bg-primary-100 text-blue-700 border-blue-100 dark:bg-blue-900/20 dark:text-blue-400',
    Medium: 'bg-teal-50 text-teal-700 border-teal-100 dark:bg-teal-900/20 dark:text-teal-400',
    High: 'bg-cyan-50 text-cyan-700 border-cyan-100 dark:bg-cyan-900/20 dark:text-cyan-400',
  ...
  const statusColors: Record<string, string> = {
    ...
    Trial: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-400',
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: 'Total Subscribers', value: totalSubscribersCount, desc: 'Registered subscribers', icon: Users, bg: 'bg-primary-500/10 text-primary-600' },
