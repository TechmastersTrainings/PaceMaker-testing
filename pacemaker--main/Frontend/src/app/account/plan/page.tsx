...
function StudentAccountPage() {
  ...
  // Color schemas
  const planDetails = {
    Basic: { icon: Shield, gradient: 'from-cyan-600 to-teal-600 shadow-cyan-500/20' },
    Medium: { icon: Zap, gradient: 'from-teal-600 to-cyan-600 shadow-teal-500/20' },
    High: { icon: Star, gradient: 'from-cyan-500 to-teal-500 shadow-cyan-500/20' },
  ...
  const statusColors = {
    ...
    Trial: 'bg-cyan-500 text-white border-cyan-600'
  };
                ...
                <div key={card.id} className="group relative border border-gray-100 bg-gray-50/50 rounded-2xl p-4 flex items-center justify-between gap-3 shadow-inner hover:border-gray-200 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-white border border-gray-100 flex items-center justify-center shrink-0 shadow-sm">
                      <CreditCard className={`w-5 h-5 ${card.type === 'visa' ? 'text-primary-500' : card.type === 'mastercard' ? 'text-red-500' : 'text-teal-500'}`} />
                    </div>
                    <div>
        ...
        {showPauseModal && (
          <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            ...
            >
              ...
              <div className="bg-primary-100/50 border border-blue-100 rounded-[2rem] p-5 space-y-2.5">
                ...
                <p className="text-[11px] text-primary-600 font-bold leading-relaxed">During a subscription freeze, your billing is completely paused and you won't be charged. Access to videos and premium mock tests will remain locked until the freeze period expires or you manually reactivate.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button 
                    ...
                    className="flex-1 py-3.5 bg-primary-600 hover:bg-blue-700 text-white rounded-xl text-xs font-black shadow transition-all"
                  >
                    Confirm Freeze
                  </button>
                </div>
