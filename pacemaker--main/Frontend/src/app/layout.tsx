...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`antialiased ${plusJakartaSans.variable} ${outfit.variable}`}>
      <body className="min-h-screen flex flex-col pt-16 selection:bg-primary-200 selection:text-primary-900 font-sans">
        <Navbar />
        <main className="flex-1 flex flex-col relative">
          <div className="absolute inset-0 -z-10 h-full w-full bg-[#fafaf9] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:24px_24px]">
